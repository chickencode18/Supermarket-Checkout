...
total_price = 0
total_quantity = 0
products_detected = {}  # {'ten_san_pham': {'price': ..., 'quantity': ...}}
...
model = YOLO("D:/code/Computer_vision1/runs/detect/train/weights/best.pt")
...
def run_image_test():
    ...
    # Đọc ảnh đầu vào
    img = cv2.imread(r"D:\Downloads\test.jpg")
    ...
    # Vẽ tổng tiền và số lượng
    cv2.putText(img, f"Tong so luong: {total_quantity}", (10, 30),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
    cv2.putText(img, f"Tong tien: {total_price:.2f} VND", (10, 60),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
    ...
    print("Đã xử lý ảnh. Truy cập http://127.0.0.1:5000/checkout để xem hóa đơn.")
